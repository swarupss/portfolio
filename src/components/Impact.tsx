...
import { impactData } from '../data/manageData';

const iconMap = {
  'ETL Performance Optimization': Zap,
  'Cloud Data Migration': Cloud,
  'Data Quality Framework': Shield,
  'Big-Data Performance': Rocket,
  'Warehouse & SCD Engineering': Database,
};
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {impactData.map((impact, index) => {
            const IconComponent = iconMap[impact.title as keyof typeof iconMap] || Zap;
            return (
              <div
                key={index}
